...
Reference this before building any branded document, deck, or dashboard for GE Vernova OFS Training. Source: GE Vernova OFS Training Design System (`_ds/ge-vernova-ofs-training-design-system-bdce87b1-cf6e-44c8-a53e-36a36984975a/`).
...
- Self-hosted Sons Condensed files: `_ds/ge-vernova-ofs-training-design-system-bdce87b1-cf6e-44c8-a53e-36a36984975a/assets/fonts/SonsCondensed-Extrabold.ttf`, `SonsCondensed-Semibold.ttf`.

## Logo

- Path: `_ds/ge-vernova-ofs-training-design-system-bdce87b1-cf6e-44c8-a53e-36a36984975a/assets/logo/`
  - `ge-vernova-evergreen.png` — light backgrounds
  - `ge-vernova-white.png` — dark backgrounds
...
Tokens/components/guide: `_ds/ge-vernova-ofs-training-design-system-bdce87b1-cf6e-44c8-a53e-36a36984975a/` (load `_ds_bundle.js` + `styles.css` in any Design Component).
